...
BOEFFLA_VERSION="V1.1.3"
TOOLCHAIN=${HOME}/Android/toolchains/UBERTC-aarch64-linux-android-5.3-kernel/bin/aarch64-linux-android-
ARCHITECTURE=arm64
...
KERNEL_NAME="Radioactive-Kernel"
...
step4_prepare_anykernel()
{
	...
	COPYRIGHT="(c) Ramon Cuenca (aka acuicultor), $(date +%Y.%m.%d-%H:%M:%S)"
